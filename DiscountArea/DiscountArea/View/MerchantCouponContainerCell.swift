...
class MerchantCouponContainerCell: UITableViewCell {
    ...
    override func systemLayoutSizeFitting(_ targetSize: CGSize, withHorizontalFittingPriority horizontalFittingPriority: UILayoutPriority, verticalFittingPriority: UILayoutPriority) -> CGSize {
        ...
        let height = merchantCouponTableView.contentSize.height
        return CGSize(width: targetSize.width, height: height)
    }
    
    func configure(with coupons: [MerchantCoupon], isExpanded: Bool) {
        self.merchantCouponList = coupons
        self.merchantCouponisExpanded = isExpanded
    }
}
